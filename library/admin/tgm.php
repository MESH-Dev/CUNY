...
add_action( 'tgmpa_register', 'fotomag_register_required_plugins' );
/**
 ...
 */
function fotomag_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'source'             => esc_url( get_stylesheet_directory() ) . '/library/extensions/vafpress-post-formats-ui-develop.zip', // The plugin source.
